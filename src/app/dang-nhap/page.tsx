...
function AuthForm() {
  ...
  const handleAuthSubmit = (e: React.FormEvent) => {
    ...
    if (!validateSchoolEmail(email)) {
      setErrorMessage("Vui lòng nhập đúng Email trường cấp (@sv.ctut.edu.vn hoặc @ctut.edu.vn)!");
      return;
    }
  ...
  const handleGoogleLogin = () => {
    // Xử lý xác thực Google OAuth2 tại đây
  ...
  />
      ...
      {/* NÚT ĐĂNG NHẬP GOOGLE BẰNG EMAIL TRƯỜNG */}
      <button
        type="button"
